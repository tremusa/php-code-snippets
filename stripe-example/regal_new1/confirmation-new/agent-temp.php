  ...
  <div class="row">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-11">
        <!--start form  -->
        <form id="confirmation-form" action="secure-payment-temp.php" method="post" autocomplete="off" data-parsley-validate>
          <input type="hidden" name="agentid" id="agentid" value="<?php echo $_GET['agentid']; ?>" >
          <div class="box">
            <h2>Your Agency Information</h2>
            <div class="row">
                <div class="col-xs-12 col-sm-8">
                  <div class="form-group">
                    <label for="agencyName">Agency Name</label>
                    <input type="text" class="form-control" name="agencyName" required="" data-parsley-error-message="Please enter the name of your agency.">
                  </div>
                </div>
              </div>
          </div>
