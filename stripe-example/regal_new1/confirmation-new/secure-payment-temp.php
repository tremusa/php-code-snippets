...
include('inc/header-internal.php');
?>
<style type="text/css">
ul{
  ...
  <div class="row">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-11">
        <!--start form  -->
          <form id="confirmation-form" method="post" action="secure-payment-temp.php" autocomplete="off" data-parsley-validate>
            <input type="hidden" name="agentid" value="<?php echo $_POST['agentid']; ?>">
            <input type="hidden" name="agencyName" value="<?php echo $_POST['agencyName']; ?>">
          ...
          <div class="box">
            <div class="row">
              <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                  <label for="">This card belongs to:</label>
                  <select class="form-control" name="ccBelong" required="" data-parsley-error-message="Please choonse card belogs to">
                    <option value="" selected disabled>Choose One</option>
                    <option value="Passenger">The Passenger</option>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-4">
                <div class="form-group">
                  <label for="">Your Agency Commission</label>
                  <input class="form-control"type="text" name="agentCommission" value="" data-parsley-type="number">
                </div>
              </div>
            </div>
...
<?php include('inc/footer-internal.php'); ?>
